...
namespace ObjectDetection
{
    class Program
    {
        ...
        {
            //First, load the image and get the height and width dimensions
            ...
            foreach (var box in filteredBoundingBoxes)
            {
               ...
               // Because the dimensions of the bounding box correspond to the model input of 416 x 416, 
                ...
                //Then, define a template for text that will appear above each bounding box.
                ...
                using (Graphics thumbnailGraphic = Graphics.FromImage(image))
                {
                    ...
                    //Then, Draw the text and bounding box on the image 
        ...
        //for additional feedback that the application is making predictions as expected at runtime
